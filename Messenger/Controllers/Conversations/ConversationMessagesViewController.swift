...
class ConversationMessagesViewController: MessagesViewController {
...
extension ConversationMessagesViewController: MessagesDataSource, MessagesLayoutDelegate, MessagesDisplayDelegate {
    ...
    func configureAvatarView(_ avatarView: AvatarView, for message: MessageType, at indexPath: IndexPath, in messagesCollectionView: MessagesCollectionView) {
        ...
        if sender.senderId == selfSender?.senderId {
            ...
            if let otherUserImage = self.receiverPhotoURL {
...
extension ConversationMessagesViewController: MessageCellDelegate {
    ...
    func inputBar(_ inputBar: InputBarAccessoryView, didPressSendButtonWith text: String) {
        ...
        if isNewConversation {
            DatabaseManager.shared.createNewConversation(with: otherUserEmail, name: self.title ?? "User", firstMessage: message, completion: { [weak self] success in
                ...
                if success {
                    print("Message Sent")
                    safeSelf.isNewConversation = false
                    
                    let newConversationId = "conversation_\(message.messageId)"
                    safeSelf.conversationId = newConversationId
                    safeSelf.listenForMessages(id: newConversationId)
                } else {
...
extension ConversationMessagesViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
